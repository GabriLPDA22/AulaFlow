        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessToken = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeadCaptureEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    LeadCapturePrompt = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssistantSettings_Businesses_BusinessId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeadCaptured = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KnowledgeSources_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssistantSettings_BusinessId",
                table: "AssistantSettings",
                column: "BusinessId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Businesses_BusinessToken",
                table: "Businesses",
                column: "BusinessToken",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KnowledgeSources_BusinessId",
